...
print("shap of s1", s1.shape)
print("shap of s2", s2.shape)
# Create outlier detection plot
fig = pyplot.figure(1)
ax2 = fig.add_subplot(111)

ax2.scatter(normal, X_val_scaled[normal][:,0], c= 'blue', marker='*', label='Correct', s=1)
ax2.scatter(anomaly, X_val_scaled[anomaly][:,0], c= 'red', marker='*', label='Error', s=5)
