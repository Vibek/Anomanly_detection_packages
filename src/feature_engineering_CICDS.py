...
print("Loading.....")
train_data, train_labels, test_data, test_labels = cicids_data_common(params)
print("train shape: ", train_data.shape)
print("test shape: ", test_data.shape)
encoded_train_label = test_data.reshape((-1, 1))
...
autoencoder_1, encoder_1, autoencoder_2, encoder_2, autoencoder_3, encoder_3, sSAE, SAE_encoder = build_cicds_AE(rho=0.04)
...
ae_1_filepath="/home/vibek/Anomanly_detection_packages/DNN_Package/Model_AE/best_ae_cids_1.hdf5"
...
autoencoder_1.load_weights('/home/vibek/Anomanly_detection_packages/DNN_Package/Model_AE/best_ae_cids_1.hdf5')
...
ae_2_filepath="/home/vibek/Anomanly_detection_packages/DNN_Package/Model_AE/best_ae_cids_2.hdf5"
...
autoencoder_2.load_weights('/home/vibek/Anomanly_detection_packages/DNN_Package/Model_AE/best_ae_cids_2.hdf5')
...
ae_3_filepath="/home/vibek/Anomanly_detection_packages/DNN_Package/Model_AE/best_ae_cids_3.hdf5"
...
autoencoder_3.load_weights('/home/vibek/Anomanly_detection_packages/DNN_Package/Model_AE/best_ae_cids_3.hdf5')
...
np.save('/home/vibek/Anomanly_detection_packages/DNN_Package/Encoded_data/encoded_train_cids.npy', encoded_train_data)
np.save('/home/vibek/Anomanly_detection_packages/DNN_Package/Encoded_data/train_label_cids.npy', encoded_train_label)
np.save('/home/vibek/Anomanly_detection_packages/DNN_Package/Encoded_data/encoded_test_cids.npy', encoded_test_data)
np.save('/home/vibek/Anomanly_detection_packages/DNN_Package/Encoded_data/test_label_cids.npy', encoded_test_label)

print('encoded_test_label:', encoded_test_label)
print('encoded_train_label:', test_data)