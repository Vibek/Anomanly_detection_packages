...
X_train, X_vald, y_train, y_vald = train_test_split(Xtrain, ytrain,
                                                test_size=0.2, 
                                                random_state=42,
                                                stratify=ytrain)

print("NetML train shape: ", X_train.shape)
print("NetML train_label shape: ", y_train.shape)
print("NetML validation shape: ", X_vald.shape)
print("NetML Validation_label shape: ", y_vald.shape)


print("Loading AutoEncoder model....\n")
autoencoder_1, encoder_1, autoencoder_2, encoder_2, autoencoder_3, encoder_3, sSAE, SAE_encoder = build_NetML_AE()
...
model.save("/home/vibek/Anomanly_detection_packages/DNN_Package/best_model_NetML_DNN.hdf5")
print("Done Training...")
